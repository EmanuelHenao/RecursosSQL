...
public class Consultar extends javax.swing.JInternalFrame {
    ...
    public Consultar(DefaultTableModel modelo, String punto) {
        initComponents();

        jTConsulta.setModel(modelo);
        jLabel1.setText(jLabel1.getText() + " " + punto);
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 153, 0), new java.awt.Color(0, 153, 51)));
